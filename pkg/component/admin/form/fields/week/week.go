...
// 设置Key
func (p *Week) SetKey(key string, crypt bool) *Week {
...
// Set style.
func (p *Week) SetStyle(style map[string]interface{}) *Week {
	p.Style = style
...
func (p *Week) SetTooltip(tooltip string) *Week {
	p.Tooltip = tooltip
...
func (p *Week) SetWidth(width interface{}) *Week {
...
func (p *Week) SetColon(colon bool) *Week {
	p.Colon = colon
	return p
}

// 额外的提示信息，和 help 类似，当需要错误信息和提示文案同时出现时，可以使用这个。
func (p *Week) SetExtra(extra string) *Week {
	p.Extra = extra
	return p
}

// 配合 validateStatus 属性使用，展示校验状态图标，建议只配合 Input 组件使用
func (p *Week) SetHasFeedback(hasFeedback bool) *Week {
	p.HasFeedback = hasFeedback
	return p
}

// 配合 help 属性使用，展示校验状态图标，建议只配合 Input 组件使用
func (p *Week) SetHelp(help string) *Week {
	p.Help = help
	return p
}

// 为 true 时不带样式，作为纯字段控件使用
func (p *Week) SetNoStyle() *Week {
	p.NoStyle = true
	return p
}

// label 标签的文本
func (p *Week) SetLabel(label string) *Week {
	p.Label = label
...
// 标签文本对齐方式
func (p *Week) SetLabelAlign(align string) *Week {
	p.LabelAlign = align
	return p
}
...
func (p *Week) SetLabelCol(col interface{}) *Week {
	p.LabelCol = col
	return p
}

// 字段名，支持数组
func (p *Week) SetName(name string) *Week {
	p.Name = name
	return p
}

// 是否必填，如不设置，则会根据校验规则自动生成
func (p *Week) SetRequired() *Week {
	p.Required = true
	return p
}

// 获取前端验证规则
func (p *Week) GetFrontendRules(path string) *Week {
	var (
...
// 校验规则，设置字段的校验逻辑
func (p *Week) SetRules(rules []*rule.Rule) *Week {
	p.Rules = rules
...
// 校验规则，只在创建表单提交时生效
func (p *Week) SetCreationRules(rules []*rule.Rule) *Week {
...
// 校验规则，只在更新表单提交时生效
func (p *Week) SetUpdateRules(rules []*rule.Rule) *Week {
	p.UpdateRules = rules
...
func (p *Week) SetValuePropName(valuePropName string) *Week {
...
func (p *Week) SetWrapperCol(col interface{}) *Week {
	p.WrapperCol = col
	return p
}

// 设置保存值。
func (p *Week) SetValue(value interface{}) *Week {
	p.Value = value
	return p
}

// 设置默认值。
func (p *Week) SetDefault(value interface{}) *Week {
	p.DefaultValue = value
	return p
}

// 是否禁用状态，默认为 false
func (p *Week) SetDisabled(disabled bool) *Week {
	p.Disabled = disabled
	return p
}

// 是否忽略保存到数据库，默认为 false
func (p *Week) SetIgnore(ignore bool) *Week {
	p.Ignore = ignore
	return p
}

// 表单联动
func (p *Week) SetWhen(value ...any) *Week {
	w := when.New()
	i := when.NewItem()
	var operator string
	var option any
...
func (p *Week) HideFromIndex(callback bool) *Week {
...
func (p *Week) HideFromDetail(callback bool) *Week {
...
func (p *Week) HideWhenCreating(callback bool) *Week {
...
func (p *Week) HideWhenUpdating(callback bool) *Week {
...
func (p *Week) HideWhenExporting(callback bool) *Week {
...
func (p *Week) HideWhenImporting(callback bool) *Week {
...
// Specify that the element should be hidden from the index view.
func (p *Week) OnIndexShowing(callback bool) *Week {
	p.ShowOnIndex = callback
...
// Specify that the element should be hidden from the detail view.
func (p *Week) OnDetailShowing(callback bool) *Week {
	p.ShowOnDetail = callback
...
// Specify that the element should be hidden from the creation view.
func (p *Week) ShowOnCreating(callback bool) *Week {
	p.ShowOnCreation = callback
...
// Specify that the element should be hidden from the update view.
func (p *Week) ShowOnUpdating(callback bool) *Week {
	p.ShowOnUpdate = callback
...
// Specify that the element should be hidden from the export file.
func (p *Week) ShowOnExporting(callback bool) *Week {
	p.ShowOnExport = callback
...
// Specify that the element should be hidden from the import file.
func (p *Week) ShowOnImporting(callback bool) *Week {
	p.ShowOnImport = callback
...
func (p *Week) ExceptOnForms() *Week {
	p.ShowOnIndex = true
	p.ShowOnDetail = true
	p.ShowOnCreation = false
	p.ShowOnUpdate = false
...
func (p *Week) IsShownOnUpdate() bool {
	return p.ShowOnUpdate
}

// Check showing on index.
func (p *Week) IsShownOnIndex() bool {
	return p.ShowOnIndex
}

// Check showing on detail.
func (p *Week) IsShownOnDetail() bool {
	return p.ShowOnDetail
}

// Check for showing when creating.
func (p *Week) IsShownOnCreation() bool {
	return p.ShowOnCreation
}

// Check for showing when exporting.
func (p *Week) IsShownOnExport() bool {
	return p.ShowOnExport
}

// Check for showing when importing.
func (p *Week) IsShownOnImport() bool {
	return p.ShowOnImport
}

// 设置为可编辑列
func (p *Week) SetEditable(editable bool) *Week {
	p.Editable = editable
...
// 闭包，透传表格列的属性
func (p *Week) SetColumn(f func(column *table.Column) *table.Column) *Week {
	p.Column = f(p.Column)
...
// 当前列值的枚举 valueEnum
func (p *Week) GetValueEnum() map[interface{}]interface{} {
...
// 设置回调函数
func (p *Week) SetCallback(closure func() interface{}) *Week {
	if closure != nil {
		p.Callback = closure
	}
...
// 获取回调函数
func (p *Week) GetCallback() interface{} {
	return p.Callback
}

// 获取数据接口
func (p *Week) SetApi(api string) *Week {
	p.Api = api
	return p
}

// 可以点击清除图标删除内容
func (p *Week) SetAllowClear(allowClear bool) *Week {
...
// 自动获取焦点，默认false
func (p *Week) SetAutoFocus(autoFocus bool) *Week {
...
// 是否有边框，默认true
func (p *Week) SetBordered(bordered bool) *Week {
	p.Bordered = bordered
...
// 自定义类名
func (p *Week) SetClassName(className string) *Week {
...
// 默认的选中项
func (p *Week) SetDefaultValue(defaultValue interface{}) *Week {
...
func (p *Week) SetFormat(format string) *Week {
	p.Format = format
...
// 自定义类名
func (p *Week) SetPopupClassName(popupClassName string) *Week {
...
func (p *Week) SetInputReadOnly(inputReadOnly bool) *Week {
...
// 国际化配置
func (p *Week) SetLocale(locale interface{}) *Week {
	p.Locale = locale
...
func (p *Week) SetMode(mode string) *Week {
	p.Mode = mode
...
// 自定义下一个图标
func (p *Week) SetNextIcon(nextIcon interface{}) *Week {
	p.NextIcon = nextIcon
...
// 控制浮层显隐
func (p *Week) SetOpen(open bool) *Week {
	p.Open = open
...
func (p *Week) SetPicker(picker string) *Week {
	p.Picker = picker
...
// 输入框占位文本
func (p *Week) SetPlaceholder(placeholder string) *Week {
...
func (p *Week) SetPlacement(placement string) *Week {
...
// 额外的弹出日历样式
func (p *Week) SetPopupStyle(popupStyle interface{}) *Week {
...
// 自定义上一个图标
func (p *Week) SetPrevIcon(prevIcon interface{}) *Week {
	p.PrevIcon = prevIcon
...
func (p *Week) SetSize(size string) *Week {
	p.Size = size
...
func (p *Week) SetStatus(status string) *Week {
	p.Status = status
...
// 自定义的选择框后缀图标
func (p *Week) SetSuffixIcon(suffixIcon interface{}) *Week {
...
// 自定义 << 切换图标
func (p *Week) SetSuperNextIcon(superNextIcon interface{}) *Week {
...
// 自定义 >> 切换图标
func (p *Week) SetSuperPrevIcon(superPrevIcon interface{}) *Week {
...
// 默认面板日期
func (p *Week) SetDefaultPickerValue(defaultPickerValue string) *Week {
...
func (p *Week) SetShowNow(showNow bool) *Week {
	p.ShowNow = showNow
...
// 增加时间选择功能
func (p *Week) SetShowTime(showTime interface{}) *Week {
	p.ShowTime = showTime
...
// 是否展示“今天”按钮
func (p *Week) SetShowToday(showToday bool) *Week {
