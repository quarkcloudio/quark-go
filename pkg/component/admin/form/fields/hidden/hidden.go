...
// 设置Key
func (p *Hidden) SetKey(key string, crypt bool) *Hidden {
...
func (p *Hidden) SetTooltip(tooltip string) *Hidden {
	p.Tooltip = tooltip
...
func (p *Hidden) SetColon(colon bool) *Hidden {
	p.Colon = colon
	return p
}

// 额外的提示信息，和 help 类似，当需要错误信息和提示文案同时出现时，可以使用这个。
func (p *Hidden) SetExtra(extra string) *Hidden {
	p.Extra = extra
	return p
}

// 配合 validateStatus 属性使用，展示校验状态图标，建议只配合 Input 组件使用
func (p *Hidden) SetHasFeedback(hasFeedback bool) *Hidden {
	p.HasFeedback = hasFeedback
	return p
}

// 配合 help 属性使用，展示校验状态图标，建议只配合 Input 组件使用
func (p *Hidden) SetHelp(help string) *Hidden {
	p.Help = help
	return p
}

// 为 true 时不带样式，作为纯字段控件使用
func (p *Hidden) SetNoStyle() *Hidden {
	p.NoStyle = true
	return p
}

// label 标签的文本
func (p *Hidden) SetLabel(label string) *Hidden {
	p.Label = label
...
// 标签文本对齐方式
func (p *Hidden) SetLabelAlign(align string) *Hidden {
	p.LabelAlign = align
	return p
}
...
func (p *Hidden) SetLabelCol(col interface{}) *Hidden {
	p.LabelCol = col
	return p
}

// 字段名，支持数组
func (p *Hidden) SetName(name string) *Hidden {
	p.Name = name
	return p
}

// 是否必填，如不设置，则会根据校验规则自动生成
func (p *Hidden) SetRequired() *Hidden {
	p.Required = true
	return p
}

// 获取前端验证规则
func (p *Hidden) GetFrontendRules(path string) *Hidden {
	var (
...
// 校验规则，设置字段的校验逻辑
func (p *Hidden) SetRules(rules []*rule.Rule) *Hidden {
	p.Rules = rules
...
// 校验规则，只在创建表单提交时生效
func (p *Hidden) SetCreationRules(rules []*rule.Rule) *Hidden {
...
// 校验规则，只在更新表单提交时生效
func (p *Hidden) SetUpdateRules(rules []*rule.Rule) *Hidden {
	p.UpdateRules = rules
...
func (p *Hidden) SetValuePropName(valuePropName string) *Hidden {
...
func (p *Hidden) SetWrapperCol(col interface{}) *Hidden {
	p.WrapperCol = col
	return p
}

// 是否忽略保存到数据库，默认为 false
func (p *Hidden) SetIgnore(ignore bool) *Hidden {
	p.Ignore = ignore
	return p
}

// 表单联动
func (p *Hidden) SetWhen(value ...any) *Hidden {
	w := when.New()
	i := when.NewItem()
	var operator string
	var option any
...
func (p *Hidden) HideFromIndex(callback bool) *Hidden {
...
func (p *Hidden) HideFromDetail(callback bool) *Hidden {
...
func (p *Hidden) HideWhenCreating(callback bool) *Hidden {
...
func (p *Hidden) HideWhenUpdating(callback bool) *Hidden {
...
func (p *Hidden) HideWhenExporting(callback bool) *Hidden {
...
func (p *Hidden) HideWhenImporting(callback bool) *Hidden {
...
// Specify that the element should be hidden from the index view.
func (p *Hidden) OnIndexShowing(callback bool) *Hidden {
	p.ShowOnIndex = callback
...
// Specify that the element should be hidden from the detail view.
func (p *Hidden) OnDetailShowing(callback bool) *Hidden {
	p.ShowOnDetail = callback
...
// Specify that the element should be hidden from the creation view.
func (p *Hidden) ShowOnCreating(callback bool) *Hidden {
	p.ShowOnCreation = callback
...
// Specify that the element should be hidden from the update view.
func (p *Hidden) ShowOnUpdating(callback bool) *Hidden {
	p.ShowOnUpdate = callback
...
// Specify that the element should be hidden from the export file.
func (p *Hidden) ShowOnExporting(callback bool) *Hidden {
	p.ShowOnExport = callback
...
// Specify that the element should be hidden from the import file.
func (p *Hidden) ShowOnImporting(callback bool) *Hidden {
	p.ShowOnImport = callback
...
func (p *Hidden) OnlyOnIndex() *Hidden {
	p.ShowOnIndex = true
...
func (p *Hidden) OnlyOnDetail() *Hidden {
	p.ShowOnIndex = false
	p.ShowOnDetail = true
	p.ShowOnCreation = false
	p.ShowOnUpdate = false
...
func (p *Hidden) OnlyOnForms() *Hidden {
	p.ShowOnIndex = false
	p.ShowOnDetail = false
	p.ShowOnCreation = true
	p.ShowOnUpdate = true
...
func (p *Hidden) OnlyOnExport() *Hidden {
	p.ShowOnIndex = false
	p.ShowOnDetail = false
	p.ShowOnCreation = false
	p.ShowOnUpdate = false
...
func (p *Hidden) OnlyOnImport() *Hidden {
	p.ShowOnIndex = false
	p.ShowOnDetail = false
	p.ShowOnCreation = false
	p.ShowOnUpdate = false
...
func (p *Hidden) ExceptOnForms() *Hidden {
	p.ShowOnIndex = true
	p.ShowOnDetail = true
	p.ShowOnCreation = false
	p.ShowOnUpdate = false
...
func (p *Hidden) IsShownOnUpdate() bool {
	return p.ShowOnUpdate
}

// Check showing on index.
func (p *Hidden) IsShownOnIndex() bool {
	return p.ShowOnIndex
}

// Check showing on detail.
func (p *Hidden) IsShownOnDetail() bool {
	return p.ShowOnDetail
}

// Check for showing when creating.
func (p *Hidden) IsShownOnCreation() bool {
	return p.ShowOnCreation
}

// Check for showing when exporting.
func (p *Hidden) IsShownOnExport() bool {
	return p.ShowOnExport
}

// Check for showing when importing.
func (p *Hidden) IsShownOnImport() bool {
	return p.ShowOnImport
}

// 设置为可编辑列
func (p *Hidden) SetEditable(editable bool) *Hidden {
	p.Editable = editable
...
// 闭包，透传表格列的属性
func (p *Hidden) SetColumn(f func(column *table.Column) *table.Column) *Hidden {
	p.Column = f(p.Column)
...
// 当前列值的枚举 valueEnum
func (p *Hidden) GetValueEnum() map[interface{}]interface{} {
...
// 设置回调函数
func (p *Hidden) SetCallback(closure func() interface{}) *Hidden {
	if closure != nil {
		p.Callback = closure
	}
...
// 获取回调函数
func (p *Hidden) GetCallback() interface{} {
	return p.Callback
}

// 获取数据接口
func (p *Hidden) SetApi(api string) *Hidden {
	p.Api = api
	return p
}
