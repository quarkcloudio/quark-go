...
// 设置Key
func (p *Time) SetKey(key string, crypt bool) *Time {
...
// Set style.
func (p *Time) SetStyle(style map[string]interface{}) *Time {
	p.Style = style
...
func (p *Time) SetTooltip(tooltip string) *Time {
	p.Tooltip = tooltip
...
func (p *Time) SetWidth(width interface{}) *Time {
...
func (p *Time) SetColon(colon bool) *Time {
	p.Colon = colon
	return p
}

// 额外的提示信息，和 help 类似，当需要错误信息和提示文案同时出现时，可以使用这个。
func (p *Time) SetExtra(extra string) *Time {
	p.Extra = extra
	return p
}

// 配合 validateStatus 属性使用，展示校验状态图标，建议只配合 Input 组件使用
func (p *Time) SetHasFeedback(hasFeedback bool) *Time {
	p.HasFeedback = hasFeedback
	return p
}

// 配合 help 属性使用，展示校验状态图标，建议只配合 Input 组件使用
func (p *Time) SetHelp(help string) *Time {
	p.Help = help
	return p
}

// 为 true 时不带样式，作为纯字段控件使用
func (p *Time) SetNoStyle() *Time {
	p.NoStyle = true
	return p
}

// label 标签的文本
func (p *Time) SetLabel(label string) *Time {
	p.Label = label
...
// 标签文本对齐方式
func (p *Time) SetLabelAlign(align string) *Time {
	p.LabelAlign = align
	return p
}
...
func (p *Time) SetLabelCol(col interface{}) *Time {
	p.LabelCol = col
	return p
}

// 字段名，支持数组
func (p *Time) SetName(name string) *Time {
	p.Name = name
	return p
}

// 是否必填，如不设置，则会根据校验规则自动生成
func (p *Time) SetRequired() *Time {
	p.Required = true
	return p
}

// 获取前端验证规则
func (p *Time) GetFrontendRules(path string) *Time {
	var (
...
// 校验规则，设置字段的校验逻辑
func (p *Time) SetRules(rules []*rule.Rule) *Time {
	p.Rules = rules
...
// 校验规则，只在创建表单提交时生效
func (p *Time) SetCreationRules(rules []*rule.Rule) *Time {
...
// 校验规则，只在更新表单提交时生效
func (p *Time) SetUpdateRules(rules []*rule.Rule) *Time {
	p.UpdateRules = rules
...
func (p *Time) SetValuePropName(valuePropName string) *Time {
...
func (p *Time) SetWrapperCol(col interface{}) *Time {
	p.WrapperCol = col
	return p
}

// 设置保存值。
func (p *Time) SetValue(value interface{}) *Time {
	p.Value = value
	return p
}

// 设置默认值。
func (p *Time) SetDefault(value interface{}) *Time {
	p.DefaultValue = value
	return p
}

// 是否禁用状态，默认为 false
func (p *Time) SetDisabled(disabled bool) *Time {
	p.Disabled = disabled
	return p
}

// 是否忽略保存到数据库，默认为 false
func (p *Time) SetIgnore(ignore bool) *Time {
	p.Ignore = ignore
	return p
}

// 表单联动
func (p *Time) SetWhen(value ...any) *Time {
	w := when.New()
	i := when.NewItem()
	var operator string
	var option any
...
func (p *Time) HideFromIndex(callback bool) *Time {
...
func (p *Time) HideFromDetail(callback bool) *Time {
...
func (p *Time) HideWhenCreating(callback bool) *Time {
...
func (p *Time) HideWhenUpdating(callback bool) *Time {
...
func (p *Time) HideWhenExporting(callback bool) *Time {
...
func (p *Time) HideWhenImporting(callback bool) *Time {
...
// Specify that the element should be hidden from the index view.
func (p *Time) OnIndexShowing(callback bool) *Time {
	p.ShowOnIndex = callback
...
// Specify that the element should be hidden from the detail view.
func (p *Time) OnDetailShowing(callback bool) *Time {
	p.ShowOnDetail = callback
...
// Specify that the element should be hidden from the creation view.
func (p *Time) ShowOnCreating(callback bool) *Time {
	p.ShowOnCreation = callback
...
// Specify that the element should be hidden from the update view.
func (p *Time) ShowOnUpdating(callback bool) *Time {
	p.ShowOnUpdate = callback
...
// Specify that the element should be hidden from the export file.
func (p *Time) ShowOnExporting(callback bool) *Time {
	p.ShowOnExport = callback
...
// Specify that the element should be hidden from the import file.
func (p *Time) ShowOnImporting(callback bool) *Time {
	p.ShowOnImport = callback
...
func (p *Time) ExceptOnForms() *Time {
	p.ShowOnIndex = true
	p.ShowOnDetail = true
	p.ShowOnCreation = false
	p.ShowOnUpdate = false
...
func (p *Time) IsShownOnUpdate() bool {
	return p.ShowOnUpdate
}

// Check showing on index.
func (p *Time) IsShownOnIndex() bool {
	return p.ShowOnIndex
}

// Check showing on detail.
func (p *Time) IsShownOnDetail() bool {
	return p.ShowOnDetail
}

// Check for showing when creating.
func (p *Time) IsShownOnCreation() bool {
	return p.ShowOnCreation
}

// Check for showing when exporting.
func (p *Time) IsShownOnExport() bool {
	return p.ShowOnExport
}

// Check for showing when importing.
func (p *Time) IsShownOnImport() bool {
	return p.ShowOnImport
}

// 设置为可编辑列
func (p *Time) SetEditable(editable bool) *Time {
	p.Editable = editable
...
// 闭包，透传表格列的属性
func (p *Time) SetColumn(f func(column *table.Column) *table.Column) *Time {
	p.Column = f(p.Column)
...
// 当前列值的枚举 valueEnum
func (p *Time) GetValueEnum() map[interface{}]interface{} {
...
// 设置回调函数
func (p *Time) SetCallback(closure func() interface{}) *Time {
	if closure != nil {
		p.Callback = closure
	}
...
// 获取回调函数
func (p *Time) GetCallback() interface{} {
	return p.Callback
}

// 获取数据接口
func (p *Time) SetApi(api string) *Time {
	p.Api = api
	return p
}

// 可以点击清除图标删除内容
func (p *Time) SetAllowClear(allowClear bool) *Time {
...
// 自动获取焦点，默认false
func (p *Time) SetAutoFocus(autoFocus bool) *Time {
...
// 是否有边框，默认true
func (p *Time) SetBordered(bordered bool) *Time {
	p.Bordered = bordered
...
// 自定义类名
func (p *Time) SetClassName(className string) *Time {
...
// 自定义的清除图标
func (p *Time) SetClearIcon(clearIcon interface{}) *Time {
...
// 清除按钮的提示文案
func (p *Time) SetClearText(clearText string) *Time {
...
// 不可选择的时间
func (p *Time) SetDisabledTime(disabledTime interface{}) *Time {
...
// 隐藏禁止选择的选项
func (p *Time) SetHideDisabledOptions(hideDisabledOptions bool) *Time {
...
// 小时选项间隔
func (p *Time) SetHourStep(hourStep int) *Time {
	p.HourStep = hourStep
...
// 分钟选项间隔
func (p *Time) SetMinuteStep(minuteStep int) *Time {
...
// 秒选项间隔
func (p *Time) SetSecondStep(secondStep int) *Time {
...
func (p *Time) SetUse12Hours(use12Hours bool) *Time {
...
// 默认的选中项
func (p *Time) SetDefaultValue(defaultValue interface{}) *Time {
...
// 自定义类名
func (p *Time) SetPopupClassName(popupClassName string) *Time {
...
func (p *Time) SetInputReadOnly(inputReadOnly bool) *Time {
...
// 控制浮层显隐
func (p *Time) SetOpen(open bool) *Time {
	p.Open = open
...
// 输入框占位文本
func (p *Time) SetPlaceholder(placeholder string) *Time {
...
func (p *Time) SetPlacement(placement string) *Time {
...
// 额外的弹出日历样式
func (p *Time) SetPopupStyle(popupStyle interface{}) *Time {
...
func (p *Time) SetSize(size string) *Time {
	p.Size = size
...
func (p *Time) SetStatus(status string) *Time {
	p.Status = status
...
// 自定义的选择框后缀图标
func (p *Time) SetSuffixIcon(suffixIcon interface{}) *Time {
...
func (p *Time) SetShowNow(showNow bool) *Time {
	p.ShowNow = showNow
