...
// 设置Key
func (p *Quarter) SetKey(key string, crypt bool) *Quarter {
...
// Set style.
func (p *Quarter) SetStyle(style map[string]interface{}) *Quarter {
	p.Style = style
...
func (p *Quarter) SetTooltip(tooltip string) *Quarter {
	p.Tooltip = tooltip
...
func (p *Quarter) SetWidth(width interface{}) *Quarter {
...
func (p *Quarter) SetColon(colon bool) *Quarter {
	p.Colon = colon
	return p
}

// 额外的提示信息，和 help 类似，当需要错误信息和提示文案同时出现时，可以使用这个。
func (p *Quarter) SetExtra(extra string) *Quarter {
	p.Extra = extra
	return p
}

// 配合 validateStatus 属性使用，展示校验状态图标，建议只配合 Input 组件使用
func (p *Quarter) SetHasFeedback(hasFeedback bool) *Quarter {
	p.HasFeedback = hasFeedback
	return p
}

// 配合 help 属性使用，展示校验状态图标，建议只配合 Input 组件使用
func (p *Quarter) SetHelp(help string) *Quarter {
	p.Help = help
	return p
}

// 为 true 时不带样式，作为纯字段控件使用
func (p *Quarter) SetNoStyle() *Quarter {
	p.NoStyle = true
	return p
}

// label 标签的文本
func (p *Quarter) SetLabel(label string) *Quarter {
	p.Label = label
...
// 标签文本对齐方式
func (p *Quarter) SetLabelAlign(align string) *Quarter {
	p.LabelAlign = align
	return p
}
...
func (p *Quarter) SetLabelCol(col interface{}) *Quarter {
	p.LabelCol = col
	return p
}

// 字段名，支持数组
func (p *Quarter) SetName(name string) *Quarter {
	p.Name = name
	return p
}

// 是否必填，如不设置，则会根据校验规则自动生成
func (p *Quarter) SetRequired() *Quarter {
	p.Required = true
	return p
}

// 获取前端验证规则
func (p *Quarter) GetFrontendRules(path string) *Quarter {
	var (
...
// 校验规则，设置字段的校验逻辑
func (p *Quarter) SetRules(rules []*rule.Rule) *Quarter {
	p.Rules = rules
...
// 校验规则，只在创建表单提交时生效
func (p *Quarter) SetCreationRules(rules []*rule.Rule) *Quarter {
...
// 校验规则，只在更新表单提交时生效
func (p *Quarter) SetUpdateRules(rules []*rule.Rule) *Quarter {
	p.UpdateRules = rules
...
func (p *Quarter) SetValuePropName(valuePropName string) *Quarter {
...
func (p *Quarter) SetWrapperCol(col interface{}) *Quarter {
	p.WrapperCol = col
	return p
}

// 设置保存值。
func (p *Quarter) SetValue(value interface{}) *Quarter {
	p.Value = value
	return p
}

// 设置默认值。
func (p *Quarter) SetDefault(value interface{}) *Quarter {
	p.DefaultValue = value
	return p
}

// 是否禁用状态，默认为 false
func (p *Quarter) SetDisabled(disabled bool) *Quarter {
	p.Disabled = disabled
	return p
}

// 是否忽略保存到数据库，默认为 false
func (p *Quarter) SetIgnore(ignore bool) *Quarter {
	p.Ignore = ignore
	return p
}

// 表单联动
func (p *Quarter) SetWhen(value ...any) *Quarter {
	w := when.New()
	i := when.NewItem()
	var operator string
	var option any
...
func (p *Quarter) HideFromIndex(callback bool) *Quarter {
...
func (p *Quarter) HideFromDetail(callback bool) *Quarter {
...
func (p *Quarter) HideWhenCreating(callback bool) *Quarter {
...
func (p *Quarter) HideWhenUpdating(callback bool) *Quarter {
...
func (p *Quarter) HideWhenExporting(callback bool) *Quarter {
...
func (p *Quarter) HideWhenImporting(callback bool) *Quarter {
...
// Specify that the element should be hidden from the index view.
func (p *Quarter) OnIndexShowing(callback bool) *Quarter {
	p.ShowOnIndex = callback
...
// Specify that the element should be hidden from the detail view.
func (p *Quarter) OnDetailShowing(callback bool) *Quarter {
	p.ShowOnDetail = callback
...
// Specify that the element should be hidden from the creation view.
func (p *Quarter) ShowOnCreating(callback bool) *Quarter {
	p.ShowOnCreation = callback
...
// Specify that the element should be hidden from the update view.
func (p *Quarter) ShowOnUpdating(callback bool) *Quarter {
	p.ShowOnUpdate = callback
...
// Specify that the element should be hidden from the export file.
func (p *Quarter) ShowOnExporting(callback bool) *Quarter {
	p.ShowOnExport = callback
...
// Specify that the element should be hidden from the import file.
func (p *Quarter) ShowOnImporting(callback bool) *Quarter {
	p.ShowOnImport = callback
...
func (p *Quarter) OnlyOnIndex() *Quarter {
	p.ShowOnIndex = true
...
func (p *Quarter) OnlyOnDetail() *Quarter {
	p.ShowOnIndex = false
	p.ShowOnDetail = true
	p.ShowOnCreation = false
	p.ShowOnUpdate = false
...
func (p *Quarter) OnlyOnForms() *Quarter {
	p.ShowOnIndex = false
	p.ShowOnDetail = false
	p.ShowOnCreation = true
	p.ShowOnUpdate = true
...
func (p *Quarter) OnlyOnExport() *Quarter {
	p.ShowOnIndex = false
	p.ShowOnDetail = false
	p.ShowOnCreation = false
	p.ShowOnUpdate = false
...
func (p *Quarter) OnlyOnImport() *Quarter {
	p.ShowOnIndex = false
	p.ShowOnDetail = false
	p.ShowOnCreation = false
	p.ShowOnUpdate = false
...
func (p *Quarter) ExceptOnForms() *Quarter {
	p.ShowOnIndex = true
	p.ShowOnDetail = true
	p.ShowOnCreation = false
	p.ShowOnUpdate = false
...
func (p *Quarter) IsShownOnUpdate() bool {
	return p.ShowOnUpdate
}

// Check showing on index.
func (p *Quarter) IsShownOnIndex() bool {
	return p.ShowOnIndex
}

// Check showing on detail.
func (p *Quarter) IsShownOnDetail() bool {
	return p.ShowOnDetail
}

// Check for showing when creating.
func (p *Quarter) IsShownOnCreation() bool {
	return p.ShowOnCreation
}

// Check for showing when exporting.
func (p *Quarter) IsShownOnExport() bool {
	return p.ShowOnExport
}

// Check for showing when importing.
func (p *Quarter) IsShownOnImport() bool {
	return p.ShowOnImport
}

// 设置为可编辑列
func (p *Quarter) SetEditable(editable bool) *Quarter {
	p.Editable = editable
...
// 闭包，透传表格列的属性
func (p *Quarter) SetColumn(f func(column *table.Column) *table.Column) *Quarter {
	p.Column = f(p.Column)
...
// 当前列值的枚举 valueEnum
func (p *Quarter) GetValueEnum() map[interface{}]interface{} {
...
// 设置回调函数
func (p *Quarter) SetCallback(closure func() interface{}) *Quarter {
	if closure != nil {
		p.Callback = closure
	}
...
// 获取回调函数
func (p *Quarter) GetCallback() interface{} {
	return p.Callback
}

// 获取数据接口
func (p *Quarter) SetApi(api string) *Quarter {
	p.Api = api
	return p
}

// 可以点击清除图标删除内容
func (p *Quarter) SetAllowClear(allowClear bool) *Quarter {
...
// 自动获取焦点，默认false
func (p *Quarter) SetAutoFocus(autoFocus bool) *Quarter {
...
// 是否有边框，默认true
func (p *Quarter) SetBordered(bordered bool) *Quarter {
	p.Bordered = bordered
...
// 自定义类名
func (p *Quarter) SetClassName(className string) *Quarter {
...
// 默认的选中项
func (p *Quarter) SetDefaultValue(defaultValue interface{}) *Quarter {
...
func (p *Quarter) SetFormat(format string) *Quarter {
	p.Format = format
...
// 自定义类名
func (p *Quarter) SetPopupClassName(popupClassName string) *Quarter {
...
func (p *Quarter) SetInputReadOnly(inputReadOnly bool) *Quarter {
...
// 国际化配置
func (p *Quarter) SetLocale(locale interface{}) *Quarter {
	p.Locale = locale
...
func (p *Quarter) SetMode(mode string) *Quarter {
	p.Mode = mode
...
// 自定义下一个图标
func (p *Quarter) SetNextIcon(nextIcon interface{}) *Quarter {
	p.NextIcon = nextIcon
...
// 控制浮层显隐
func (p *Quarter) SetOpen(open bool) *Quarter {
	p.Open = open
...
func (p *Quarter) SetPicker(picker string) *Quarter {
	p.Picker = picker
...
// 输入框占位文本
func (p *Quarter) SetPlaceholder(placeholder string) *Quarter {
...
func (p *Quarter) SetPlacement(placement string) *Quarter {
...
// 额外的弹出日历样式
func (p *Quarter) SetPopupStyle(popupStyle interface{}) *Quarter {
...
// 自定义上一个图标
func (p *Quarter) SetPrevIcon(prevIcon interface{}) *Quarter {
	p.PrevIcon = prevIcon
...
func (p *Quarter) SetSize(size string) *Quarter {
	p.Size = size
...
func (p *Quarter) SetStatus(status string) *Quarter {
	p.Status = status
...
// 自定义的选择框后缀图标
func (p *Quarter) SetSuffixIcon(suffixIcon interface{}) *Quarter {
...
// 自定义 << 切换图标
func (p *Quarter) SetSuperNextIcon(superNextIcon interface{}) *Quarter {
...
// 自定义 >> 切换图标
func (p *Quarter) SetSuperPrevIcon(superPrevIcon interface{}) *Quarter {
...
// 默认面板日期
func (p *Quarter) SetDefaultPickerValue(defaultPickerValue string) *Quarter {
...
func (p *Quarter) SetShowNow(showNow bool) *Quarter {
	p.ShowNow = showNow
...
// 增加时间选择功能
func (p *Quarter) SetShowTime(showTime interface{}) *Quarter {
	p.ShowTime = showTime
...
// 是否展示“今天”按钮
func (p *Quarter) SetShowToday(showToday bool) *Quarter {
