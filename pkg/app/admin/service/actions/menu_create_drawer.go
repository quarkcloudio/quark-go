...
// 初始化
func (p *MenuCreateDrawerAction) Init(ctx *builder.Context) interface{} {
...
// 内容
func (p *MenuCreateDrawerAction) GetBody(ctx *builder.Context) interface{} {
	template := ctx.Template.(types.Resourcer)
...
// 弹窗行为
func (p *MenuCreateDrawerAction) GetActions(ctx *builder.Context) []interface{} {
