...
func (p *Menu) Seeder() {
	seeders := []Menu{
		...
		{Id: 7, Name: "系统配置", GuardName: "admin", Icon: "ant-design:setting-outlined", Type: 1, Pid: 0, Sort: 100, Path: "system", Query: "", Component: "", Show: 1, IsEngine: 0, IsLink: 0, IsFrame: 0, Status: 1, Perms: "", HideInMenu: false},
		{Id: 8, Name: "设置管理", GuardName: "admin", Icon: "ant-design:appstore-add-outlined", Type: 1, Pid: 7, Sort: 0, Path: "config", Query: "", Component: "", Show: 1, IsEngine: 0, IsLink: 0, IsFrame: 0, Status: 1, Perms: "", HideInMenu: false},
		{Id: 9, Name: "网站设置", GuardName: "admin", Icon: "ant-design:cluster-outlined", Type: 2, Pid: 8, Sort: 0, Path: "webConfig", Query: "{\"api\":\"/api/admin/webConfig/form\"}", Component: "", Show: 1, IsEngine: 1, IsLink: 0, IsFrame: 0, Status: 1, Perms: "", HideInMenu: false},
		{Id: 10, Name: "配置管理", GuardName: "admin", Icon: "ant-design:tool-outlined", Type: 2, Pid: 8, Sort: 0, Path: "config", Query: "{\"api\":\"/api/admin/config/index\"}", Component: "", Show: 1, IsEngine: 1, IsLink: 0, IsFrame: 0, Status: 1, Perms: "", HideInMenu: false},
		{Id: 11, Name: "菜单管理", GuardName: "admin", Icon: "ant-design:menu-outlined", Type: 2, Pid: 7, Sort: 0, Path: "menu", Query: "{\"api\":\"/api/admin/menu/index\"}", Component: "", Show: 1, IsEngine: 1, IsLink: 0, IsFrame: 0, Status: 1, Perms: "", HideInMenu: false},
		{Id: 12, Name: "操作日志", GuardName: "admin", Icon: "ant-design:file-done-outlined", Type: 2, Pid: 7, Sort: 100, Path: "actionLog", Query: "{\"api\":\"/api/admin/actionLog/index\"}", Component: "", Show: 1, IsEngine: 1, IsLink: 0, IsFrame: 0, Status: 1, Perms: "", HideInMenu: false},
		{Id: 13, Name: "附件空间", GuardName: "admin", Icon: "ant-design:folder-outlined", Type: 1, Pid: 0, Sort: 100, Path: "attachment", Query: "", Component: "", Show: 1, IsEngine: 0, IsLink: 0, IsFrame: 0, Status: 1, Perms: "", HideInMenu: false},
		{Id: 14, Name: "文件管理", GuardName: "admin", Icon: "ant-design:file-outlined", Type: 2, Pid: 13, Sort: 0, Path: "file", Query: "{\"api\":\"/api/admin/file/index\"}", Component: "", Show: 1, IsEngine: 1, IsLink: 0, IsFrame: 0, Status: 1, Perms: "", HideInMenu: false},
		{Id: 15, Name: "图片管理", GuardName: "admin", Icon: "ant-design:picture-outlined", Type: 2, Pid: 13, Sort: 0, Path: "image", Query: "{\"api\":\"/api/admin/image/index\"}", Component: "", Show: 1, IsEngine: 1, IsLink: 0, IsFrame: 0, Status: 1, Perms: "", HideInMenu: false},
		{Id: 16, Name: "我的账号", GuardName: "admin", Icon: "ant-design:user-outlined", Type: 1, Pid: 0, Sort: 110, Path: "account", Query: "", Component: "", Show: 1, IsEngine: 0, IsLink: 0, IsFrame: 0, Status: 1, Perms: "", HideInMenu: false},
		...
		{Id: 21, Name: "组件开发", GuardName: "admin", Icon: "ant-design:experiment-outlined", Type: 2, Pid: 20, Sort: 0, Path: "index", Query: "", Component: "develop/index", Show: 1, IsEngine: 0, IsLink: 0, IsFrame: 0, Status: 1, Perms: "", HideInMenu: false},
	}
