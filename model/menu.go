...
func (p *Menu) Seeder() {
	seeders := []Menu{
		...
		{Id: 16, Name: "我的账号", GuardName: "admin", Icon: "ant-design:user-outlined", Type: 1, Pid: 0, Sort: 100, Path: "account", Query: "", Component: "", Show: 1, IsEngine: 0, IsLink: 0, IsFrame: 0, Status: 1, Perms: "", HideInMenu: false},
