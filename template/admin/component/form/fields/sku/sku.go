...
type OptionItem struct {
	...
	CheckedChildren   string      `json:"checkedChildren,omitempty"`
	UnCheckedChildren string      `json:"unCheckedChildren,omitempty"`
}
...
type Component struct {
	...
	PatchChangeButtonText     string      `json:"patchChangeButtonText,omitempty"`     // 批量修改按钮文本，默认：批量修改
	PatchClearButtonText      string      `json:"patchClearButtonText,omitempty"`      // 批量清理按钮文本，默认：清空
	Items                     []Item      `json:"items,omitempty"`                     // 规格属性相关字段，暂时只支持Form的text、number、imagepicker,select、switch组件
	CheckedItem               OptionItem  `json:"checkedItem,omitempty"`               // 默认选中栏
	OptionItem                OptionItem  `json:"optionItem,omitempty"`                // 操作栏
}
...
// 商品规格表单name，默认：attributes
func (p *Component) SetAttributesName(attributesName string) *Component {
	p.AttributesName = attributesName
	return p
}

// 商品规格标签文本，默认：商品规格
func (p *Component) SetAttributesLabel(attributesLabel string) *Component {
	p.AttributesLabel = attributesLabel
	return p
}

// 商品属性标签文本，默认：商品属性
func (p *Component) SetDataSourceLabel(dataSourceLabel string) *Component {
	p.DataSourceLabel = dataSourceLabel
	return p
}

// 商品属性规格名称文本，默认：规格名称
func (p *Component) SetAttrNameLabel(attrNameLabel string) *Component {
	p.AttrNameLabel = attrNameLabel
	return p
}

// 商品属性规格值文本，默认：规格值
func (p *Component) SetAttrValueLabel(attrValueLabel string) *Component {
	p.AttrValueLabel = attrValueLabel
	return p
}

// 添加规格项按钮文本，默认：添加规格项
func (p *Component) SetCreateAttrButtonText(createAttrButtonText string) *Component {
	p.CreateAttrButtonText = createAttrButtonText
	return p
}

// 添加规格值按钮文本，默认：新建
func (p *Component) SetCreateAttrValueButtonText(createAttrValueButtonText string) *Component {
	p.CreateAttrValueButtonText = createAttrValueButtonText
	return p
}

// 批量修改按钮文本，默认：批量修改
func (p *Component) SetPatchChangeButtonText(patchChangeButtonText string) *Component {
	p.PatchChangeButtonText = patchChangeButtonText
	return p
}

// 批量清理按钮文本，默认：清空
func (p *Component) SetPatchClearButtonText(patchClearButtonText string) *Component {
	p.PatchClearButtonText = patchClearButtonText
	return p
}

// 将表单项转换为表格列
func (p *Component) fieldToItem(field interface{}) Item {
...
// 规格属性相关字段，暂时只支持Form的text、number、imagepicker、select、switch组件
func (p *Component) SetFields(fields []interface{}) *Component {
	items := []Item{}
	for _, item := range fields {
		field := p.fieldToItem(item)
...
// 默认选中栏
func (p *Component) SetCheckedItem(checkedItem OptionItem) *Component {
	p.CheckedItem = checkedItem
	return p
}

// 操作栏
func (p *Component) SetOptionItem(optionItem OptionItem) *Component {
	p.OptionItem = optionItem
	return p
}
